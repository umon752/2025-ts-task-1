...
export const catKeyName: string = PlantCategory["LargePlant"];
...
export function updatePlant(input: PlantBase): Required<PlantBase> {
...
*/
type UpdateProduct = Partial<Omit<Product, "id" | "title">> & Required<Pick<Product, "id" | "title">>;
...
*/
const submitProduct = (type: "create" | "update", product: Product): string | undefined => {
  if(type === 'create') {
